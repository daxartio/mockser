...
First off, thank you for considering contributing to mockser.
...
[issue tracker](https://github.com/daxartio/mockser/issues),
...
```shell
git clone https://github.com/daxartio/mockser
cd mockser
cargo test
```
